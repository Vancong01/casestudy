...
public class SupplierController {
    ...
    public ModelAndView saveSupplier(@ModelAttribute("supplier") Supplier supplier, RedirectAttributes redirectAttributes){
        supplierService.save(supplier);
        ModelAndView modelAndView = new ModelAndView("redirect:suppliers");
        modelAndView.addObject("supplier",new Supplier());
    ...
    public ModelAndView updateSupplier(@ModelAttribute("supplier") Supplier supplier,RedirectAttributes redirectAttributes){
        supplierService.save(supplier);
